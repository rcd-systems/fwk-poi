...
public class RcdPoiXlsWorkbook
    extends LinkedHashMap<String, RcdXlsSheet>
    implements RcdXlsWorkbook
{
    ...
    public String toString()
    {
        ...
        {
            sb.append( "Sheet '" + entry.getKey() + "'" ).append( System.lineSeparator() ).append( entry.getValue().toString() ).append(
